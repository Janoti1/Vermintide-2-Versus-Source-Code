...
HeroWindowLoadoutSelectionConsole._get_input_service = function (self)
	return not (not self._context_menu_active and not self._on_add_loadout_button) and Managers.input:get_service("hero_view") or self._parent:window_input_service()
end
